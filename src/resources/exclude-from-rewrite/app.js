...
/***/ "./src/css/exclude-from-rewrite/app.scss":
/*!***********************************************!*\
  !*** ./src/css/exclude-from-rewrite/app.scss ***!
  \***********************************************/
/*! no static exports found */
...
/***/ "./src/js/exclude-from-rewrite/app.js":
/*!********************************************!*\
  !*** ./src/js/exclude-from-rewrite/app.js ***!
  \********************************************/
/*! no exports provided */
...
/* harmony import */ var _main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.js */ "./src/js/exclude-from-rewrite/main.js");

_main_js__WEBPACK_IMPORTED_MODULE_0__["default"].init();

/***/ }),

/***/ "./src/js/exclude-from-rewrite/main.js":
/*!*********************************************!*\
  !*** ./src/js/exclude-from-rewrite/main.js ***!
  \*********************************************/
...
var isPageSuitable = function isPageSuitable() {
  var $fields = document.querySelectorAll('#slug-field');
  return $fields.length > 0;
};

var buildLightSwitch = function buildLightSwitch() {
  var hiddenFieldName = 'slugEqualsTitle_shouldRewrite';
  var $markup = "\n  <div class=\"lightswitch fieldtoggle\" tabindex=\"0\" data-value=\"1\" id=\"".concat(hiddenFieldName, "\" data-target=\"").concat(hiddenFieldName, "-field\" role=\"checkbox\" aria-checked=\"false\">\n    <div class=\"lightswitch-container\">\n        <div class=\"label on\"></div>\n        <div class=\"handle\"></div>\n        <div class=\"label off\"></div>\n    </div>\n    <input type=\"hidden\" name=\"").concat(hiddenFieldName, "\" value=\"\"></div>\n");
  var $lightSwitch = document.createElement('div');
  $lightSwitch.innerHTML = $markup;
  $slugField.appendChild($lightSwitch);
  $toggleContainer = $slugField.querySelector("#".concat(hiddenFieldName));
  lightSwitch = new Craft.LightSwitch($toggleContainer);
  var width = $slugFieldInputContainer.getBoundingClientRect().width - $toggleContainer.getBoundingClientRect().width;
  var spaceRight = 10;
  $slugFieldInputContainer.style.width = "".concat(width - spaceRight, "px");
  $slugFieldInputContainer.style.marginRight = "".concat(spaceRight, "px");
  $toggleInput = document.querySelector("[name=".concat(hiddenFieldName, "]"));
};
...
/***/ 0:
/*!******************************************************************************************!*\
  !*** multi ./src/js/exclude-from-rewrite/app.js ./src/css/exclude-from-rewrite/app.scss ***!
  \******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
